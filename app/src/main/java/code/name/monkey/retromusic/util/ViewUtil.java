...
public class ViewUtil {
    ...
    public static void showDonationDialog(final AppCompatActivity activity) {
        View view = LayoutInflater.from(activity).inflate(R.layout.donate_layout, null);
        TextView title = ButterKnife.findById(view, R.id.title);
        title.setMovementMethod(LinkMovementMethod.getInstance());

        View donate = ButterKnife.findById(view, R.id.donate);
        donate.setOnClickListener(v -> activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.PAYPAL_ME_URL))));
